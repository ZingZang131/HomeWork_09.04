// Задание 1
 ...
 // Запрос у пользователя его возраст
 let age = prompt("Ваш возраст?");

 // Вывод сообщение с возрастом пользователя
 console.log(`Вам ${age} лет`);
 
 // Запрос у пользователя его имя
 let name = prompt("Как вас зовут?");
 
 // Вывод приветственное сообщение с именем пользователя
